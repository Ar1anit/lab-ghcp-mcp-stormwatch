...
public sealed class LocalVectorKnowledgeRetriever : IKnowledgeRetriever
{
    ...
    public static Task<LocalVectorKnowledgeRetriever> CreateAsync(
        LocalRagSettings settings,
        ITextEmbeddingService embeddingService,
        CancellationToken cancellationToken = default)
    {
        _ = settings;
        _ = embeddingService;
        // TODO 3: Load and chunk rag-data, generate embeddings, and build the local index.
    ...
    {
        _ = question;
        // TODO 3: Embed the question and rank local chunks by cosine similarity.
        throw new NotImplementedException();
    }
